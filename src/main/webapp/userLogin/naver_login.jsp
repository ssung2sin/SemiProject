...
var naverLogin = new naver.LoginWithNaverId(
	...
	var naverLogin = new naver.LoginWithNaverId(
			{
				clientId: "r1ELIdSzzQk6g7kY9OiQ", //내 애플리케이션 정보에 cliendId를 입력해줍니다.
				callbackUrl: "http://localhost:8080/SemiProject/userLogin/naver_login.html", // 내 애플리케이션 API설정의 Callback URL 을 입력해줍니다.
				isPopup: false,
				callbackHandle: true
			}
		);	
